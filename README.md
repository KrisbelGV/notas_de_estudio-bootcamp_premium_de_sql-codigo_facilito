...
Soy nueva usando GitHub y actualmente curso el Bootcamp Premium de SQL en Código Facilito, estas son mis notas de estudio.
...
- La información aquí compartida consiste en un vistazo general (no detallado) a los temas propuestos y desarrollados por el programa.
